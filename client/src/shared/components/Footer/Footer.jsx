    ...
    <footer className="cf-footer">
      <div className="cf-footer-inner">
        <div className="cf-footer-brand">
          ...
          <p className="cf-footer-desc cf-footer-desc-full">
            CatFecito - Café con amor. Descubre y compra los mejores granos
            seleccionados.
          </p>
          <p className="cf-footer-desc cf-footer-desc-short">
            CatFecito - Café con amor.
          </p>
        </div>
        ...
        <div className="cf-footer-links">
          ...
          <div>
            ...
            <div className="cf-socials">
              <a
                href="https://www.instagram.com/catfecitoARG/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/catfecitoARG"
                target="_blank"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://twitter.com/catfecitoARG"
                target="_blank"
                aria-label="Twitter"
              >
      ...
      <div className="cf-footer-bottom">
        <p>
          © {new Date().getFullYear()} CatFecito. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
